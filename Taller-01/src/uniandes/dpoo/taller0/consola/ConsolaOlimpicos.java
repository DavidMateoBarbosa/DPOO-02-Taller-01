...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisPorAtelta() {
		...
		Atleta atletaInfo = calculadora.paisPorAtleta(atleta);
		if (atletaInfo != null)
			System.out.println("El atleta '" + atletaInfo.darNombre() + "' es del país: " + atletaInfo.darPais().darNombre());
		else
			System.out.println("El atleta '" + atleta + "' no esta en la base de datos ");
	}
